...
<div class="main-content">
  <section class="section">
    <div class="section-header justify-content-center bg-danger rounded-lg">
      <h1 class="text-white">PILIH JENIS PELAYANAN</h1>
    </div>

    <div class="section-body">
      <div class="row sortable-card text-center">
        <div class="col-12 col-md-6 col-lg-4">
          <div class="card card-danger text-center rounded-lg">
            <div class="card-header justify-content-center">
              <img src="assets/img/kk.jpg" alt="logo" width="220">
            </div>
            <div class="card-body">
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <div class="card card-danger rounded-lg">
            <div class="card-header justify-content-center">
              <img src="assets/img/akta_lahir.png" alt="logo" width="220">
            </div>
            <div class="card-body">
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <div class="card card-danger rounded-lg">
            <div class="card-header justify-content-center">
              <img src="assets/img/surat_pindah.jpg" alt="logo" width="220">
            </div>
            <div class="card-body">
              <h5>Surat Pindah</h5>
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <div class="card card-danger rounded-lg">
            <div class="card-header justify-content-center">
              <img src="assets/img/akta_mati.jpg" alt="logo" width="220">
            </div>
            <div class="card-body">
              <h5>Akta Kematian</h5>
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <div class="card card-danger rounded-lg">
            <div class="card-header justify-content-center">
              <img src="assets/img/pindah_datang.jpg" alt="logo" width="220">
            </div>
            <div class="card-body">
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <div class="card card-danger rounded-lg">
            <div class="card-header justify-content-center">
              <img src="assets/img/wni.jpg" alt="logo" width="220">
            </div>
            <div class="card-body">
              <h5>Biodata WNI</h5>
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <div class="card card-danger rounded-lg">
            <div class="card-header justify-content-center">
              <img src="assets/img/ktp.png" alt="logo" width="220">
            </div>
            <div class="card-body">
              <h5>Rekam KTP</h5>
