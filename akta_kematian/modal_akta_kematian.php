    ...
    <div class="modal-content">
      ...
      <div class="modal-body" id="bodydetail">
        ...
        <form method="POST" action="akta_kematian/fungsi_akta_kematian.php" enctype="multipart/form-data" role="form">
          ...
          $q = mysqli_query($conn, "SELECT max(id_ak) as kodeTerbesar FROM tb_kematian");
          ...
          <div class="form-group">
            <label>Upload Foto/Scan SK Kepala Desa atau Rumah Sakit <span class="required-asterisk text-danger" aria-hidden="true">*</span></label>
            <div class="custom-file">
              <input type="file" class="form-control" name="file_sk" <?php if (isset($_SESSION["file_sk"])) {
                                                                        echo '';
                                                                      } else {
                                                                        echo 'required';
                                                                      } ?>>
