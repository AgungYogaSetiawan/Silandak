...
if(isset($_POST['upload'])) {
  ...
  if(empty($foto)) {
    ...
    echo "<meta http-equiv='refresh' content='0;url=index.php?page=detailAKM&id_ak=$idak'>";
  } else if (!empty($filePemohon)) {
    echo "<script>alert('File sudah diupload!');</script>";
    echo "<meta http-equiv='refresh' content='0;url=index.php?page=dataSelesaiAktaKematian'>";
  } else {
    $sql = "UPDATE tb_kematian SET file_pemohon = '$foto', slug_file = '$file' WHERE id_ak = '$id'";
    $hasil = mysqli_query($conn, $sql);
        ...
        <div class="row">
          <div class="col-12 col-sm-10 col-md-8 col-lg-8 col-xl-12">
            <form method="post" enctype="multipart/form-data" role="form">
              <input type="hidden" id="id_ak" name="id_ak" value="<?php echo $row['id_ak']; ?>" readonly>
              <div class="row">
              ...
              <div class="form-group">
                ...
                <div class="custom-file">
                  ...
                  if($ekstensi_kk == 'pdf') { 
                  ?>
                    <a href="assets/<?php echo $row['file_sk'] ?>"><i class="fa fa-file-pdf" style="font-size: 20px; color: red;"></i></a>
                  <?php } else { ?>
                    <a href="assets/<?php echo $row['file_sk'] ?>"><img src="assets/<?php echo $row['file_sk'] ?>" width="100"></a>
                  <?php } ?>
              ...
              <div class="text-danger mb-5"><h6><i class="fas fa-thumbs-up"></i> Verifikasi Persyaratan</h6></div>
                ...
                <div class="form-group">
                  ...
                  <a href="?page=dataBaruAktaKematian" class="btn btn-info btn-md">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <a href="?page=dataSelesaiAktaKematian" class="btn btn-danger btn-md mt-2">
                      <i class="fas fa-window-close"></i> Batal
                    </a>
                </form>
                </div>
