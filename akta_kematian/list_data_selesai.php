              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-striped" id="tabel">
                    ...
                    <tbody>
                      <?php
                      $query = mysqli_query($conn, "SELECT * FROM tb_kematian a INNER JOIN tb_user b ON a.user_id = b.id_user WHERE a.status_berkas='Selesai' ORDER BY a.id_ak DESC");
                      $no = 1;
                      ...
                      ?>
                        <tr>
                          ...
                          <td><a href="?page=detailAKM&id_ak=<?php echo $row['id_ak'] ?>" class="btn btn-info btnktp"><i class="fas fa-search"></i></a></td>
                        </tr>
                      <?php
                      }
                      ?>
