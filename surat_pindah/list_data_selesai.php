              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-striped" id="tabel">
                    ...
                    <tbody>
                      <?php
                      $query = mysqli_query($conn, "SELECT * FROM tb_surat_pindah a INNER JOIN tb_user b ON a.user_id = b.id_user WHERE status_berkas='Selesai'");
                      $no = 1;
                      ...
                      <tr>
                        ...
                        <td><button class="btn btn-info" data-toggle="modal" data-target="#modalViewVerifSuratPindah"><i class="fas fa-search"></i></button></td>
                      </tr>
                      <?php
                      }
                      ?>
