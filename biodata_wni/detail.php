...
if(isset($_POST['upload'])) {
  ...
  if(empty($foto)) {
    ...
    echo "<meta http-equiv='refresh' content='0;url=index.php?page=detailWNI&id_bio=$idbio'>";
  } else if (!empty($filePemohon)) {
    echo "<script>alert('File sudah diupload!');</script>";
    echo "<meta http-equiv='refresh' content='0;url=index.php?page=dataSelesaiBiodataWNI'>";
  } else {
    $sql = "UPDATE tb_bio_wni SET file_pemohon = '$foto', slug_file = '$file' WHERE id_bio = '$id'";
    $hasil = mysqli_query($conn, $sql);
            ...
            <form method="post" enctype="multipart/form-data" role="form">
              ...
              <div class="text-danger mb-5"><h6><i class="fas fa-thumbs-up"></i> Verifikasi Persyaratan</h6></div>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <a href="?page=dataSelesaiBiodataWNI" class="btn btn-danger btn-md mt-2">
                      <i class="fas fa-window-close"></i> Batal
                    </a>
                </form>
                </div>
