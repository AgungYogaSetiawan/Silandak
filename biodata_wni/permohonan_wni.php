                ...
                <div class="table-responsive">
                  <table class="table table-striped" id="tabel">
                    ...
                    <tbody>
                      <?php
                      $sesi = $_SESSION['id'];
                      $query = mysqli_query($conn, "SELECT * FROM tb_bio_wni a INNER JOIN tb_user b ON a.user_id = b.id_user WHERE b.id_user='$sesi' ORDER BY a.id_bio DESC");
                      $no = 1;
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a href="?page=viewWNI&id_bio=<?php echo $row['id_bio'] ?>" class="btn btn-info btnktp"><i class="fas fa-search"></i></a>
                            <a href="?page=deleteWNI&id_bio=<?php echo $row['id_bio'] ?>" class="btn btn-danger" onclick="return confirm('Apakah anda yakin menghapus data ini?');"><i class="fas fa-trash"></i></a>
