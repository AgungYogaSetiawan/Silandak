<!-- Modal persyaratan -->
<div class="modal fade" id="modalPersyaratanWNI" tabindex="-1" role="dialog" aria-labelledby="modalPersyaratanWNILabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalPersyaratanWNILabel">Persyaratan dan Ketentuan</h5>
...
<div class="modal fade" id="modalDaftarWNI" tabindex="-1" role="dialog" aria-labelledby="modalDaftarWNILabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalDaftarWNILabel">Form Pendaftaran Biodata WNI</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-body" id="bodydetail">
        ...
        <form method="POST" action="biodata_wni/fungsi_wni.php" enctype="multipart/form-data" role="form">
          ...
          $q = mysqli_query($conn, "SELECT max(id_bio) as kodeTerbesar FROM tb_bio_wni");
...
<!-- Modal lihat data biodata wni -->
<div class="modal fade" id="modalLihatDataWNI" tabindex="-1" role="dialog" aria-labelledby="modalLihatDataWNILabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalLihatDataWNILabel">Permohonan Biodata WNI</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-body" id="bodydetail">
        ...
        <form method="POST" action="biodata_wni/fungsi_wni.php" enctype="multipart/form-data" role="form">
          <?php
          $id = $_SESSION['id'];
          $sql = "SELECT * FROM tb_bio_wni a INNER JOIN tb_user b ON a.user_id = b.id_user WHERE b.id_user='$id'";
          $result = mysqli_query($conn, $sql);
          $data = mysqli_fetch_array($result);
          ?>
          <input type="hidden" id="user_id" name="user_id" value="<?php echo $data['id_user']; ?>" readonly>
...
<!-- end modal lihat biodata wni -->

<!-- Modal view verif baru biodata wni -->
<div class="modal fade" id="modalViewVerifWNI" tabindex="-1" role="dialog" aria-labelledby="modalViewVerifWNILabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalViewVerifWNILabel">Form Pendaftaran Biodata WNI</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-body" id="bodydetail">
        ...
        ?>
        <form method="post" action="biodata_wni/fungsi_wni.php" enctype="multipart/form-data" role="form">
          <input type="hidden" id="user_id" name="user_id" value="<?php echo $data['id_bio']; ?>" readonly>
          <div class="row">
            <div class="form-group col-6">
...
<!-- end modal view verif baru biodata wni -->

<!-- Modal view data progress biodata wni -->
...
<!-- end modal view data progress biodata wni -->

<!-- Modal view data selesai biodata wni -->
...
<!-- end modal view data selesai biodata wni -->
<!-- END biodata wni -->