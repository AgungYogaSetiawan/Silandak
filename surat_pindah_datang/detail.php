...
if(isset($_POST['upload'])) {
  ...
  if(empty($foto)) {
    ...
    echo "<meta http-equiv='refresh' content='0;url=index.php?page=detailSPD&id_pd=$idspd'>";
  } else if (!empty($filePemohon)) {
    echo "<script>alert('File sudah diupload!');</script>";
    echo "<meta http-equiv='refresh' content='0;url=index.php?page=dataSelesaiSuratPindahDatang'>";
  } else {
    $sql = "UPDATE tb_pindah_datang SET file_pemohon = '$foto', slug_file = '$file' WHERE id_pd = '$id'";
    $hasil = mysqli_query($conn, $sql);
            ...
            <form method="post" enctype="multipart/form-data" role="form">
              ...
              <div class="form-group">
                ...
                <div class="custom-file">
                  ...
                  <p class="text-dark">File yang diunggah: <?php echo $row['slug_kp']; ?></p>
                  <?php
                  $id = $_GET['id_spd'];
                  ...
                  if($ekstensi_kk == 'pdf') { 
                  ?>
                    <a href="assets/<?php echo $row['file_kp'] ?>"><i class="fa fa-file-pdf" style="font-size: 20px; color: red;"></i></a>
                  <?php } else { ?>
                    <a href="assets/<?php echo $row['file_kp'] ?>"><img src="assets/<?php echo $row['file_kp'] ?>" width="100"></a>
                  <?php } ?>
              ...
              <div class="text-danger mb-5"><h6><i class="fas fa-thumbs-up"></i> Verifikasi Persyaratan</h6></div>
                ...
                <div class="form-group">
                  ...
                  <a href="?page=dataBaruSuratPindahDatang" class="btn btn-info btn-md">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <a href="?page=dataSelesaiSuratPindahDatang" class="btn btn-danger btn-md mt-2">
                      <i class="fas fa-window-close"></i> Batal
                    </a>
                </form>
                </div>
