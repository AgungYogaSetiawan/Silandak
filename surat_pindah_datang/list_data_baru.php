              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-striped" id="tabel">
                    ...
                    <tbody>
                      <?php
                      $query = mysqli_query($conn, "SELECT * FROM tb_pindah_datang a INNER JOIN tb_user b ON a.user_id = b.id_user WHERE a.status_berkas='Baru' ORDER BY a.id_pd DESC");
                      $no = 1;
                      ...
                      <tr>
                        ...
                        <td><a href="?page=detailSPD&id_pd=<?php echo $row['id_pd'] ?>" class="btn btn-info btnktp"><i class="fas fa-search"></i></a></td>
                      </tr>
                      <?php
                      }
                      ?>
