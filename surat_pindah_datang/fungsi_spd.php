...
if (isset($_POST['kirim'])) {
  ...
  if (isset($_SESSION['file_kp']) && isset($_SESSION['file_ktp'])) {
    $str = rand();
    $str1 = md5($str);
    ...
    $sql = "INSERT INTO tb_pindah_datang (user_id,file_kp,file_ktp,status_berkas,tgl,slug_kp,slug_ktp,nmr_urut) VALUES ('$user_id','$_SESSION[file_kp]','$_SESSION[file_ktp]','$status','$tgl_waktu','$_SESSION[slug_kp]','$_SESSION[slug_ktp]','$nmr_urut')";
  } else {
    $str = rand();
    $str1 = md5($str);
    ...
    //Query input menginput data kedalam tabel kk
    $sql = "INSERT INTO tb_pindah_datang (user_id,file_kp,file_ktp,status_berkas,tgl,slug_kp,slug_ktp,nmr_urut) VALUES ('$user_id','$file_kp','$file_ktp','$status','$tgl_waktu','$file_kp1','$file_ktp1','$nmr_urut')";
  }
