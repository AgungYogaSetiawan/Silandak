                ...
                <div class="table-responsive">
                  <table class="table table-striped" id="tabel">
                    ...
                    <tbody>
                      <?php
                      $sesi = $_SESSION['id'];
                      $query = mysqli_query($conn, "SELECT * FROM tb_pindah_datang a INNER JOIN tb_user b ON a.user_id = b.id_user WHERE b.id_user='$sesi'");
                      $no = 1;
                      ...
                      <tr>
                        ...
                        <td><button class="btn btn-info btnview" data-toggle="modal" data-target="#modalLihatDataSPD" data-id="<?php $row['id_pd']; ?>"><i class="fas fa-search"></i></button></td>
                      </tr>
                      <?php
                      }
                      ?>
