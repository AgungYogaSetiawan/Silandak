          ...
          <div class="col-12 col-sm-10 col-md-8 col-lg-8 col-xl-12">
            <div class="card card-danger">
              <div class="card-header">
                <h4 class="text-danger">Pengurusan Surat Pindah Datang</h4>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-striped" id="tabel">
                    ...
                    <tbody>
                      <?php
                      $sesi = $_SESSION['id'];
                      $query = mysqli_query($conn, "SELECT * FROM tb_pindah_datang a INNER JOIN tb_user b ON a.user_id = b.id_user WHERE b.id_user='$sesi' ORDER BY a.id_pd DESC");
                      $no = 1;
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a href="?page=viewSPD&id_spd=<?php echo $row['id_pd'] ?>" class="btn btn-info btnktp"><i class="fas fa-search"></i></a>
                            <a href="?page=deleteSPD&id_spd=<?php echo $row['id_pd'] ?>" class="btn btn-danger" onclick="return confirm('Apakah anda yakin menghapus data ini?');"><i class="fas fa-trash"></i></a>
