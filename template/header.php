...
<head>
    ...
    <title>Aplikasi Sistem Layanan Data Kecamatan Banua Lawas</title>
...
<body class="layout-3">
    <!-- Back to top button -->
    <button type="button" class="btn btn-danger btn-floating btn-lg btn-rounded" id="btn-back-to-top">
        <i class="fas fa-arrow-up"></i>
    </button>
    <div id="app">
        <div class="main-wrapper container">
            <div class="navbar-bg"></div>
            <nav class="navbar fixed-top navbar-expand-lg main-navbar container">
                <a href="?page=beranda" class="navbar-brand sidebar-gone-hide"><img src="assets/img/logo_tabalong_new.png" alt="logo" width="32"></a>
                <div class="navbar-nav">
                    <a href="#" class="nav-link sidebar-gone-show" data-toggle="sidebar"><i class="fas fa-bars"></i></a>
                </div>
                <div class="nav-collapse">
                    <ul class="navbar-nav">
                        <li class="nav-item active h6 mt-2"><a href="?page=beranda" class="nav-link">Aplikasi Sistem Layanan Data Kecamatan Banua Lawas</a></li>
                    </ul>
                </div>
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            ...
                            <div class="d-sm-none d-lg-inline-block">Hi, <strong><?php echo $_SESSION['username'] ?></strong></div>
                        </a>
            ...
            <nav class="navbar fixed-top navbar-secondary navbar-expand-lg">
                <div class="container">
                    <ul class="navbar-nav">
