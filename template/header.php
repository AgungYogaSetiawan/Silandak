            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-item"><a href="permohonanaktakematian" class="nav-link text-dark">Akta Kematian <span class="badge badge-primary"><?php echo $status_baru_ak ?></span> <span class="badge badge-warning"><?php echo $status_baru_ak ?></span> <span class="badge badge-success"><?php echo $status_selesai_ak ?></span></a></li>
                        <li class="dropdown-item"><a href="permohonansuratpindahdatang" class="nav-link text-dark">Surat Pindah Datang <span class="badge badge-primary"><?php echo $status_baru_spd ?></span> <span class="badge badge-warning"><?php echo $status_baru_spd ?></span> <span class="badge badge-success"><?php echo $status_selesai_spd ?></span></a></li>
                        <li class="dropdown-item"><a href="permohonanbiodatawni" class="nav-link text-dark">Biodata WNI <span class="badge badge-primary"><?php echo $status_baru_wni ?></span> <span class="badge badge-warning"><?php echo $status_baru_wni ?></span> <span class="badge badge-success"><?php echo $status_selesai_wni ?></span></a></li>
                        <li class="dropdown-item"><a href="permohonanrekamktp" class="nav-link text-dark">Rekam KTP <span class="badge badge-primary"><?php echo $status_baru_ktp ?></span> <span class="badge badge-warning"><?php echo $status_baru_ktp ?></span> <span class="badge badge-success"><?php echo $status_selesai_ktp ?></span></a></li>
                    </ul>
                </li>
                <?php } ?>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-item"><a href="dataBaruAktaKematian" class="nav-link text-dark">Akta Kematian <span class="badge badge-primary"><?= $status_baru_admin_ak ?></span> <span class="badge badge-warning"><?= $status_baru_admin_ak ?></span> <span class="badge badge-success"><?= $status_selesai_admin_ak ?></span></a></li>
                        <li class="dropdown-item"><a href="dataBaruSuratPindahDatang" class="nav-link text-dark">Surat Pindah Datang <span class="badge badge-primary"><?= $status_baru_admin_spd ?></span> <span class="badge badge-warning"><?= $status_baru_admin_spd ?></span> <span class="badge badge-success"><?= $status_selesai_admin_spd ?></span></a></li>
                        <li class="dropdown-item"><a href="dataBaruBiodataWNI" class="nav-link text-dark">Biodata WNI <span class="badge badge-primary"><?= $status_baru_admin_wni ?></span> <span class="badge badge-warning"><?= $status_baru_admin_wni ?></span> <span class="badge badge-success"><?= $status_selesai_admin_wni ?></span></a></li>
                        <li class="dropdown-item"><a href="dataBaruRekamKTP" class="nav-link text-dark">Rekam KTP <span class="badge badge-primary"><?= $status_baru_admin_ktp ?></span> <span class="badge badge-warning"><?= $status_baru_admin_ktp ?></span> <span class="badge badge-success"><?= $status_selesai_admin_ktp ?></span></a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-item"><a href="dataProgressAktaKematian" class="nav-link text-dark ">Akta Kematian <span class="badge badge-primary"><?= $status_baru_admin_ak ?></span> <span class="badge badge-warning"><?= $status_baru_admin_ak ?></span> <span class="badge badge-success"><?= $status_selesai_admin_ak ?></span></a></li>
                        <li class="dropdown-item"><a href="dataProgressSuratPindahDatang" class="nav-link text-dark ">Surat Pindah Datang <span class="badge badge-primary"><?= $status_baru_admin_spd ?></span> <span class="badge badge-warning"><?= $status_baru_admin_spd ?></span> <span class="badge badge-success"><?= $status_selesai_admin_spd ?></span></a></li>
                        <li class="dropdown-item"><a href="dataProgressBiodataWNI" class="nav-link text-dark ">Biodata WNI <span class="badge badge-primary"><?= $status_baru_admin_wni ?></span> <span class="badge badge-warning"><?= $status_baru_admin_wni ?></span> <span class="badge badge-success"><?= $status_selesai_admin_wni ?></span></a></li>
                        <li class="dropdown-item"><a href="dataProgressRekamKTP" class="nav-link text-dark ">Rekam KTP <span class="badge badge-primary"><?= $status_baru_admin_ktp ?></span> <span class="badge badge-warning"><?= $status_baru_admin_ktp ?></span> <span class="badge badge-success"><?= $status_selesai_admin_ktp ?></span></a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-item"><a href="dataSelesaiAktaKematian" class="nav-link text-dark">Akta Kematian <span class="badge badge-primary"><?= $status_baru_admin_ak ?></span> <span class="badge badge-warning"><?= $status_baru_admin_ak ?></span> <span class="badge badge-success"><?= $status_selesai_admin_ak ?></span></a></li>
                        <li class="dropdown-item"><a href="dataSelesaiSuratPindahDatang" class="nav-link text-dark">Surat Pindah Datang <span class="badge badge-primary"><?= $status_baru_admin_spd ?></span> <span class="badge badge-warning"><?= $status_baru_admin_spd ?></span> <span class="badge badge-success"><?= $status_selesai_admin_spd ?></span></a></li>
                        <li class="dropdown-item"><a href="dataSelesaiBiodataWNI" class="nav-link text-dark">Biodata WNI <span class="badge badge-primary"><?= $status_baru_admin_wni ?></span> <span class="badge badge-warning"><?= $status_baru_admin_wni ?></span> <span class="badge badge-success"><?= $status_selesai_admin_wni ?></span></a></li>
                        <li class="dropdown-item"><a href="dataSelesaiRekamKTP" class="nav-link text-dark">Rekam KTP <span class="badge badge-primary"><?= $status_baru_admin_ktp ?></span> <span class="badge badge-warning"><?= $status_baru_admin_ktp ?></span> <span class="badge badge-success"><?= $status_selesai_admin_ktp ?></span></a></li>
                    </ul>
                </li>
