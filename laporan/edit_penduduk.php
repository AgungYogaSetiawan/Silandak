            ...
            <form method="post" enctype="multipart/form-data" role="form">
              ...
              <div class="row">
                ...
                <div class="form-group col-6">
                  ...
                  <input id="l_awal" type="number" class="form-control" name="l_awal" value="<?php echo $row['l_awal']; ?>" oninput="JmlAkhir()">
                </div>
              </div>
              ...
              <div class="row">
                <div class="form-group col-6">
                  ...
                  <input id="p_awal" type="number" class="form-control" name="p_awal" value="<?php echo $row['p_awal']; ?>" oninput="JmlAkhir()">
                </div>
                <div class="form-group col-6">
              ...
              <div class="row">
                ...
                <div class="form-group col-6">
                  ...
                  <input id="l_lahir" type="number" class="form-control" name="l_lahir" value="<?php echo $row['l_lahir']; ?>" oninput="JmlAkhir()">
                </div>
              </div>
              <div class="row">
                <div class="form-group col-6">
                  <label for="p_lahir">Jumlah Lahir Perempuan Bulan Ini</label>
                  <input id="p_lahir" type="number" class="form-control" name="p_lahir" value="<?php echo $row['p_lahir']; ?>" oninput="JmlAkhir()">
                </div>
                <div class="form-group col-6">
              ...
              <div class="row">
                <div class="form-group col-6">
                  ...
                  <input id="l_mati" type="number" class="form-control" name="l_mati" value="<?php echo $row['l_mati']; ?>" oninput="JmlAkhir()">
                </div>
                <div class="form-group col-6">
                  <label for="p_mati">Jumlah Mati Perempuan Bulan Ini</label>
                  <input id="p_mati" type="number" class="form-control" name="p_mati" value="<?php echo $row['p_mati']; ?>" oninput="JmlAkhir()">
                </div>
              </div>
              <div class="row">
                <div class="form-group col-6">
                ...
                <div class="form-group col-6">
                  ...
                  <input id="l_datang" type="number" class="form-control" name="l_datang" value="<?php echo $row['l_datang']; ?>" oninput="JmlAkhir()">
                </div>
              </div>
              <div class="row">
                <div class="form-group col-6">
                  <label for="p_datang">Jumlah Datang Perempuan Bulan Ini</label>
                  <input id="p_datang" type="number" class="form-control" name="p_datang" value="<?php echo $row['p_datang']; ?>" oninput="JmlAkhir()">
                </div>
                <div class="form-group col-6">
              ...
              <div class="row">
                <div class="form-group col-6">
                  ...
                  <input id="l_pindah" type="number" class="form-control" name="l_pindah" value="<?php echo $row['l_pindah']; ?>" oninput="JmlAkhir()">
                </div>
                <div class="form-group col-6">
                  <label for="p_pindah">Jumlah Pindah Perempuan Bulan Ini</label>
                  <input id="p_pindah" type="number" class="form-control" name="p_pindah" value="<?php echo $row['p_pindah']; ?>" oninput="JmlAkhir()">
                </div>
              </div>
              <div class="row">
                <div class="form-group col-6">
