            ...
            <form method="post" enctype="multipart/form-data" role="form">
              ...
              <div class="row">
                <div class="form-group col-sm-4 col-md-4 col-lg-4">
                  ...
                  <input required id="l_datang" type="number" class="form-control" name="l_datang" oninput="JmlAkhir()">
                </div>
                <div class="form-group col-sm-4 col-md-4 col-lg-4">
                  ...
                  <input required id="p_datang" type="number" class="form-control" name="p_datang" oninput="JmlAkhir()">
                </div>
                <div class="form-group col-sm-4 col-md-4 col-lg-4">
                  <label for="tot_datang">Total Datang Bulan Ini <span class="required-asterisk text-danger" aria-hidden="true">*</span></label>
                  <input required id="tot_datang" type="number" class="form-control" name="tot_datang">
                </div>
              </div>
              <div class="row">
                <div class="form-group col-sm-4 col-md-4 col-lg-4">
                  ...
                  <input required id="l_pindah" type="number" class="form-control" name="l_pindah" oninput="JmlAkhir()">
                </div>
                <div class="form-group col-sm-4 col-md-4 col-lg-4">
