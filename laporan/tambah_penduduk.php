            ...
            <form method="post" enctype="multipart/form-data" role="form">
              <div class="row">
                ...
                <div class="form-group col-6">
                  ...
                  <input id="l_awal" type="number" class="form-control" name="l_awal">
                </div>
              </div>
              ...
              <div class="row">
                <div class="form-group col-6">
                  ...
                  <input id="p_awal" type="number" class="form-control" name="p_awal">
                </div>
                <div class="form-group col-6">
              ...
              <div class="row">
                ...
                <div class="form-group col-6">
                  ...
                  <input id="l_lahir" type="number" class="form-control" name="l_lahir">
                </div>
              </div>
              <div class="row">
                <div class="form-group col-6">
                  <label for="p_lahir">Jumlah Lahir Perempuan Bulan Ini</label>
                  <input id="p_lahir" type="number" class="form-control" name="p_lahir">
                </div>
                <div class="form-group col-6">
              ...
              <div class="row">
                <div class="form-group col-6">
                  ...
                  <input id="l_mati" type="number" class="form-control" name="l_mati">
                </div>
                <div class="form-group col-6">
                  <label for="p_mati">Jumlah Mati Perempuan Bulan Ini</label>
                  <input id="p_mati" type="number" class="form-control" name="p_mati">
                </div>
              </div>
              <div class="row">
                <div class="form-group col-6">
                ...
                <div class="form-group col-6">
                  ...
                  <input id="l_datang" type="number" class="form-control" name="l_datang">
                </div>
              </div>
              <div class="row">
                <div class="form-group col-6">
