                ...
                <table class="table table-hover table-bordered">
                    ...
                    <tbody>
                        ...
                        if(isset($_POST['cari'])){
                            ...
                            $query = mysqli_query($conn, "SELECT * FROM tb_penduduk WHERE desa = '$desa' AND bulan = '$bulanNow' AND tahun = '$tahunNow' LIMIT $halaman_awal, $batas");
                            $query_halaman = mysqli_query($conn, "SELECT * FROM tb_penduduk WHERE desa = '$desa' AND bulan = '$bulanNow' AND tahun = '$tahunNow'");
                            $jumlah_data = mysqli_num_rows($query_halaman);
                            $total_halaman = ceil($jumlah_data / $batas);
                        } else{
