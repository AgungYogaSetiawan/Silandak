...
if(isset($_POST['pdf'])) {
  ...
  if(!empty($bulan) && !empty($tahun)) {
    if($_SESSION['peran'] == 'admin desa'){
          $query = mysqli_query($konek, "SELECT * FROM tb_penduduk WHERE desa = '$desa' AND bulan = '$bulan' AND tahun = '$tahun'");
      } else{
          $query = mysqli_query($konek, "SELECT * FROM tb_penduduk WHERE bulan = '$bulan' AND tahun = '$tahun'");
      }
  } else {
    if($_SESSION['peran'] == 'admin desa'){
        $query = mysqli_query($konek, "SELECT * FROM tb_penduduk WHERE desa = '$desa' AND bulan = '$bulanNow' AND tahun = '$tahunNow'");
    } else{
