                            ...
                            <td>
                                <div class='btn-row'>
                                    <div class='btn-group'>
                                        ...
                                        <a href='pengguna/pengguna_delete.php?id=".$row['id_user']."' class='btn btn-danger btn-md'><i class='fas fa-trash'></i></a>
                                    </div>
                                </div>
                            </td>";
                            ?>
...
<div class="modal fade" id="modalTambahUser" tabindex="-1" role="dialog" aria-labelledby="modalTambahUserLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <hr>
            <div class="modal-body" id="bodydetail">
            <div class="text-danger mb-5"><h6><i class="fas fa-user"></i> DATA USER</h6></div>
