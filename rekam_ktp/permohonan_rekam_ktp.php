          ...
          <div class="col-12 col-sm-10 col-md-8 col-lg-8 col-xl-12">
            <div class="card card-danger">
              <div class="card-header">
                <h4 class="text-danger">Pengurusan Rekam Kartu Tanda Penduduk</h4>
              </div>
              <div class="card-body">
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="?page=deleteKTP&id_ktp=<?php echo $row['id_ktp'] ?>" class="btn btn-danger" onclick="return confirm('Apakah anda yakin menghapus data ini?');"><i class="fas fa-trash"></i></a>
