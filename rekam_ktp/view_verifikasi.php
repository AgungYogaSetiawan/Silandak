...
<div class="main-content">
  <section class="section">
    <div class="section-header justify-content-between bg-success rounded-lg">
      <h1 class="text-white">FORM PENDAFTARAN KARTU KELUARGA</h1>
        ...
        <div class="row">
          <div class="col-12 col-sm-10 col-md-8 col-lg-8 col-xl-12">
            <div class="card card-success">
              <div class="card-header text-success"><h6>DATA PEMOHON</h6></div>
              <div class="card-body">
                <form method="POST">
                  <div class="row">
                  ...
                  <hr>
                  <div class="text-success mb-5"><h6>BERKAS PERSYARATAN</h6></div>
                  <div class="form-group">
