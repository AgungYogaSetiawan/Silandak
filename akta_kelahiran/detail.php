...
if(isset($_POST['upload'])) {
  ...
  if(empty($foto)) {
    ...
    echo "<meta http-equiv='refresh' content='0;url=index.php?page=detailAK&id_lahir=$idlahir'>";
  } else if (!empty($filePemohon)) {
    echo "<script>alert('File sudah diupload!');</script>";
    echo "<meta http-equiv='refresh' content='0;url=index.php?page=dataSelesaiAktaKelahiran'>";
  } else {
    $sql = "UPDATE tb_akta_lahir SET file_pemohon = '$foto', slug_file = '$file' WHERE id_lahir = '$id'";
    $hasil = mysqli_query($conn, $sql);
        ...
        <div class="row">
          <div class="col-12 col-sm-10 col-md-8 col-lg-8 col-xl-12">
            <form method="post" enctype="multipart/form-data" role="form">
              <input type="hidden" id="id_lahir" name="id_lahir" value="<?php echo $row['id_lahir']; ?>" readonly>
              <div class="row">
              ...
              <div class="text-danger mb-5"><h6><i class="fas fa-file"></i> BERKAS PERSYARATAN</h6></div>
                ...
                <div class="custom-file">
                  ...
                  <p class="text-dark">File yang diunggah: <?php echo $row['slug_ak']; ?></p>
                  <?php
                  $id = $_GET['id_lahir'];
                  ...
                  if($ekstensi_kk == 'pdf') { 
                  ?>
                    <a href="assets/<?php echo $row['file_akta_lahir'] ?>"><i class="fa fa-file-pdf" style="font-size: 20px; color: red;"></i></a>
                  <?php } else { ?>
                    <a href="assets/<?php echo $row['file_akta_lahir'] ?>"><img src="assets/<?php echo $row['file_akta_lahir'] ?>" width="100"></a>
                  <?php } ?>
              ...
              <div class="form-group">
                ...
                <div class="custom-file">
                  ...
                  <p class="text-dark">File yang diunggah: <?php echo $row['slug_sk']; ?></p>
                  <?php
                  $id = $_GET['id_lahir'];
                  $qry = mysqli_query($conn, "SELECT * FROM tb_akta_lahir WHERE id_lahir = '$id'");
                  $qry = mysqli_fetch_array($qry);
                  ...
                  if($ekstensi_kk == 'pdf') { 
                  ?>
                    <a href="assets/<?php echo $row['file_ket_lahir'] ?>"><i class="fa fa-file-pdf" style="font-size: 20px; color: red;"></i></a>
                  <?php } else { ?>
                    <a href="assets/<?php echo $row['file_ket_lahir'] ?>"><img src="assets/<?php echo $row['file_ket_lahir'] ?>" width="100"></a>
                  <?php } ?>
                  <p style="color: red">Ekstensi yang diperbolehkan .png | .jpg | .jpeg | .pdf</p>
                </div>
              </div>
              ...
              <div class="text-danger mb-5"><h6><i class="fas fa-thumbs-up"></i> Verifikasi Persyaratan</h6></div>
                ...
                <div class="form-group">
                  ...
                  <a href="?page=dataBaruAktaKelahiran" class="btn btn-info btn-md">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <a href="?page=dataSelesaiAktaKelahiran" class="btn btn-danger btn-md mt-2">
                      <i class="fas fa-window-close"></i> Batal
                    </a>
                </form>
                </div>
