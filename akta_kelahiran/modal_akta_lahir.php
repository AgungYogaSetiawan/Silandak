    ...
    <div class="modal-content">
      ...
      <div class="modal-body" id="bodydetail">
        ...
        <form method="POST" action="akta_kelahiran/fungsi_akta_lahir.php" enctype="multipart/form-data" role="form">
          ...
          $q = mysqli_query($conn, "SELECT max(id_lahir) as kodeTerbesar FROM tb_akta_lahir");
          ...
          <div class="form-group">
            <label>Upload Foto/Scan Surat Permohonan Akta Lahir <span class="required-asterisk text-danger" aria-hidden="true">*</span></label>
            <div class="custom-file">
              <input type="file" class="form-control" name="file_akta_lahir" <?php if (isset($_SESSION["file_akta_lahir"])) {
                                                                                echo '';
                                                                              } else {
                                                                                echo 'required';
                                                                              } ?>>
              ...
              if (isset($_SESSION['file_akta_lahir'])) {
                ...
                $fileSlug = $_SESSION['slug_akta_lahir'];
          ...
          <div class="form-group">
            <label>Upload Foto/Scan Surat Keterangan Lahir <span class="required-asterisk text-danger" aria-hidden="true">*</span></label>
            <div class="custom-file">
              <input type="file" class="form-control" name="file_ket_lahir" <?php if (isset($_SESSION["file_ket_lahir"])) {
                                                                              echo '';
                                                                            } else {
                                                                              echo 'required';
                                                                            } ?>>
              ...
              if (isset($_SESSION['file_ket_lahir'])) {
                ...
                $fileSlug = $_SESSION['slug_ket_lahir'];
                echo '<p>File yang diunggah: ' . $fileSlug . '</p>';
                echo '<img src="assets/' . $fileName . '" width="100">';
              }
              ?>
          ...
          <div class="form-group">
            <label>Upload Foto/Scan Buku Nikah Orang Tua/SPTJM (misal nikah siri) <span class="required-asterisk text-danger" aria-hidden="true">*</span></label>
            <div class="custom-file">
